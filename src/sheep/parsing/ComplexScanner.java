 ...
 * @hint ComplexParser should use tokenize(String) to break a String into tokens.
 *       ComplexParser should then parse the returned list of tokens.
 * @provided
 * @test
 */
public class ComplexScanner {
    ...
    private static class TokenBuilder {
        /**
         * stringbuiler for token builder
         */
         ...
         * Any string between the open parenthesis and it's matching close parenthesis
         * is treated as the contents </p>
         * <p>
         * Characters in the list of valid operators are tokenized
         * alone as OPs with the character as the name </p>
         * <p>
         * Strings that can be parsed as a Long are tokenized as CONSTs with a
