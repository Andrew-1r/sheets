...
public class SimpleParser implements Parser {
     ...
     * <li>
     * If the string is just whitespace, an empty expression should be constructed with
     * {@link ExpressionFactory#createEmpty()}.
     * </li>
     * <li>
     ...
     * </li>
     * <li>
     * Any string that contains one of the operator names from the
     * {@link sheep.expression.arithmetic}
     ...
     * Arithmetic expressions should be constructed with
     * {@link ExpressionFactory#createOperator(String, Object[])}.
     ...
     * 2) only contains alphabetic {@link Character#isAlphabetic(int)} and digit characters
