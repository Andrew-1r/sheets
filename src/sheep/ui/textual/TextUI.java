...
public class TextUI extends UI {
    ...
    /**
     * text ui
     * @param view sheetview
     * @param updater sheet updater
     ...
     * @param view sheetview
     * @param updater sheet updater
     * @param ignoredBuilder ignored sheet builder
     * @param output output of model
     * @param input of model
     */
    public TextUI(SheetView view, SheetUpdate updater, SheetBuilder ignoredBuilder,
