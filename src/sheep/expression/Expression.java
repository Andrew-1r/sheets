...
public abstract class Expression {
     ...
     * {@code
     * Expression expr =
     * Arithmetic.plus(new Expression[]{Arithmetic.minus(new Expression[]{new Reference("A1"),
     ...
     * @throws TypeError
     * If the method is called on an expression that does not have a numeric value,
