...
public abstract class Operation extends Expression {
    ...
    /**
     * Dependencies of the operator expression. The dependencies of an operator
     * expression are the union of all
     * sub-expressions.
     * <pre>
     * {@code
     * Operator plus = Operator.plus(new Expression[]{Operator.minus(new Expression[]
     * {new Reference("A1"), new Reference("A2")}), new Reference("B1")});
     ...
     * <p>
     * An operation expression will evaluate to a {@link Constant}
     * expression that stores the result of performing the
     * specific operation.
     * <p>
     * During evaluation the operation should evaluate each sub-expression and
     * convert the resulting values to numeric
    ...
    /**
     * Evaluate the expression to a numeric value. For operation expressions,
     * a type error will always be thrown.
     *
